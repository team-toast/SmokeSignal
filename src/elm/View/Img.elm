module View.Img exposing (bookmark, close, dollar, eth, globe, help, hide, icon, link, logo, pencil, replyArrow, speechBubble, spinner, tick, walletConnect, xDai)
...
walletConnect : Int -> Element msg
walletConnect size =
    svg [ viewBox "0 0 300 185", width size ] [ Svg.path [ fill "#3B99FC", Svg.Attributes.fillRule "nonzero", d "M61.4 36.3a127.1 127.1 0 01177.2 0l5.8 5.7a6 6 0 010 8.7l-20 19.7a3.2 3.2 0 01-4.5 0l-8.1-8a88.7 88.7 0 00-123.6 0L79.5 71a3.2 3.2 0 01-4.4 0L55 51.3a6 6 0 010-8.7l6.4-6.3zM280.2 77l18 17.6a6 6 0 010 8.6l-80.9 79.2a6.4 6.4 0 01-8.8 0L151 126.2c-.6-.6-1.6-.6-2.2 0l-57.4 56.2a6.4 6.4 0 01-8.8 0L1.9 103.2a6 6 0 010-8.6L19.8 77a6.4 6.4 0 018.8 0L86 133.2a1.6 1.6 0 002.2 0L145.6 77a6.4 6.4 0 018.8 0l57.4 56.2c.6.6 1.6.6 2.2 0L271.4 77a6.4 6.4 0 018.8 0z" ] [] ]
        |> wrap


icon : Int -> Element msg
icon size =
    svg
        [ viewBox "0 0 176.39 173.99"
        , height size
        , width size
        ]
        [ Svg.defs [] [ Svg.style [] [ Svg.text ".cls-1{fill:#f69b1e;}.cls-2{fill:#808083;}.cls-3{fill:#a6a7aa;}" ] ]
        , Svg.path [ Svg.Attributes.class "cls-1", d "M96.6,166.58c1.66-2.2,7.06-7.72,7.06-18,0-14.58-18.76-22-12.64-38.67-11.81,6.26-12.82,26-8.8,32.22-3.85-1-6.36-6-6-10.12-6.36,7.52-7.65,20.72-.22,30.48,1.07,1.39,2.18,2.74,3.27,4.11l0,0s-22.07-8.16-22.07-30.3c0-34.35,31.54-35.09,24.81-68.74,15.2,11.55,19.53,35.77,19.53,50.12,6.86-3.24,7.65-13.5,7.71-13.85.19.15,10.87,13.87,10.87,31.8,0,23.61-23.36,30.92-23.55,31Z" ] []
